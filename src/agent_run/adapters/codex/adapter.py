...
from ...native_settings import CODEX_RESERVED_ROOTS, enforce_native_settings
...
class CodexAdapter:
    ...
    def validate(self, config: RuntimeConfig) -> None:
        ...
        enforce_native_settings(config.native_settings, CODEX_RESERVED_ROOTS, "codex native_settings")
    ...
    def materialize(
        ...
        *,
        ...
        """Regenerate managed assets with merged native settings.
        ...
        Args:
            ...
            skills_root (Path | None): Absolute skill source directory; None selects the runtime default.
        ...
        writes the packaged extended-context defaults deep-merged with declared
        ``native_settings`` (operator tuning wins; reserved control roots fail
        closed before this merge). Invalid declarations raise ValidationError;
        I/O and plugin errors propagate.
        """
        ...
        body_lines = [
            ...
            *render_effective_native_settings(config.native_settings),
            "",
            *permission_lines,
            *mcp_lines,
            *hook_lines,
