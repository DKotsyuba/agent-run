...
/// Mirrors `DoctorTests.test_canonical_role_readiness_uses_shared_catalog_without_runtime_home`.
#[test]
...
/// Mirrors `DoctorTests.test_canary_handshake_ok_reports_a_completed_real_handshake`.
#[test]
