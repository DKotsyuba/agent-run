...
> **Статус:** план реализации, а не отчёт о выполненной миграции. Rust-реализация, Cargo.lock и результаты её сборки этим документом не заявляются. Все этапы и приёмочные сценарии ниже предстоит выполнить.
